"""
Django settings for demo19_middleware project.
...
SECRET_KEY = 'django-insecure-@5l*l^zazc*=ip^7s=p=rj%_c^89hn%)fu!kji=)yfpv_77lrw'
...
WSGI_APPLICATION = 'demo19_middleware.wsgi.application'
